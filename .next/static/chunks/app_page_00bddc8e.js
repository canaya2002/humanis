    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            ...
            const handleScroll = {
                "HomePage.useEffect.handleScroll": ()=>{
                    ...
                    parallaxElements.forEach({
                        "HomePage.useEffect.handleScroll": (el)=>{
                    ...
                    entries.forEach({
                        "HomePage.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                setVisibleSections({
                                    "HomePage.useEffect": (prev)=>new Set([
                                            ...prev,
                                            entry.target.id
                                        ])
                                }["HomePage.useEffect"]);
            ...
            const statTimer = setInterval({
                "HomePage.useEffect.statTimer": ()=>{
                    setCurrentStat({
                        "HomePage.useEffect.statTimer": (prev)=>(prev + 1) % 4
                    }["HomePage.useEffect.statTimer"]);
                }
            }["HomePage.useEffect.statTimer"], 3000);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "55dca5f051986228",
                children: '@import "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap";*{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}body{color:#0f172a;background:#fff;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;line-height:1.6;overflow-x:hidden}::selection{color:#fff;background:#3b82f6}.container{max-width:1280px;margin:0 auto;padding:0 2rem}@media (max-width:768px){.container{padding:0 1.25rem}}.loader{z-index:9999;background:linear-gradient(135deg,#1e40af 0%,#7c3aed 100%);justify-content:center;align-items:center;transition:opacity .5s ease-out,visibility .5s ease-out;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.loader.hidden{opacity:0;visibility:hidden}.loader-spinner{border:4px solid rgba(255,255,255,.2);border-top-color:#fff;border-radius:50%;width:60px;height:60px;animation:1s linear infinite spin}@keyframes spin{to{transform:rotate(360deg)}}.nav-header{z-index:1000;-webkit-backdrop-filter:blur(20px);background:rgba(255,255,255,.98);transition:all .3s;position:fixed;top:0;left:0;right:0}.nav-header.scrolled{box-shadow:0 4px 30px rgba(0,0,0,.08)}.nav-wrapper{justify-content:space-between;align-items:center;padding:1.25rem 0;display:flex}.logo-container{align-items:center;text-decoration:none;display:flex}.logo-image{width:auto;height:80px}.nav-menu{align-items:center;gap:2.5rem;display:flex}.nav-link{color:#475569;padding:.5rem 0;font-weight:500;text-decoration:none;transition:color .3s;position:relative}.nav-link:after{content:"";background:linear-gradient(90deg,#3b82f6,#1d4ed8);width:0;height:2px;transition:width .3s;position:absolute;bottom:0;left:0}.nav-link:hover{color:#1e293b}.nav-link:hover:after{width:100%}.nav-cta{gap:1rem;display:flex}.btn{border-radius:50px;align-items:center;gap:.75rem;padding:.875rem 2rem;font-weight:600;text-decoration:none;transition:all .3s;display:inline-flex;position:relative;overflow:hidden}.btn-primary{color:#fff;background:linear-gradient(135deg,#3b82f6 0%,#1d4ed8 100%);box-shadow:0 4px 20px rgba(59,130,246,.3)}.btn-primary:hover{transform:translateY(-2px);box-shadow:0 8px 30px rgba(59,130,246,.4)}.btn-secondary{color:#475569;background:#fff;border:2px solid #e2e8f0}.btn-secondary:hover{color:#3b82f6;background:#f0f9ff;border-color:#3b82f6}.mobile-menu-btn{cursor:pointer;flex-direction:column;gap:6px;padding:8px;display:none}.mobile-menu-btn span{background:#475569;border-radius:2px;width:28px;height:2px;transition:all .3s}.mobile-menu-btn.active span:first-child{transform:rotate(45deg)translate(6px,6px)}.mobile-menu-btn.active span:nth-child(2){opacity:0}.mobile-menu-btn.active span:nth-child(3){transform:rotate(-45deg)translate(6px,-6px)}@media (max-width:1024px){.nav-menu,.nav-cta{display:none}.mobile-menu-btn{display:flex}}.mobile-menu{opacity:0;visibility:hidden;background:#fff;padding:2rem;transition:all .3s;position:fixed;top:80px;left:0;right:0;transform:translateY(-100%);box-shadow:0 10px 40px rgba(0,0,0,.1)}.mobile-menu.active{opacity:1;visibility:visible;transform:translateY(0)}.hero{background:linear-gradient(135deg,#0f172a 0%,#1e293b 100%);align-items:center;min-height:100vh;padding:8rem 0 4rem;display:flex;position:relative;overflow:hidden}.hero-bg{opacity:.1;position:absolute;top:0;bottom:0;left:0;right:0}.hero-grid{background-image:linear-gradient(rgba(255,255,255,.05) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.05) 1px,transparent 1px);background-size:50px 50px;position:absolute;top:0;bottom:0;left:0;right:0}.hero-wrapper{grid-template-columns:1fr 1fr;align-items:center;gap:4rem;display:grid}@media (max-width:1024px){.hero-wrapper{grid-template-columns:1fr;gap:3rem}}.hero-content,.hero-stats-container{z-index:10;position:relative}.hero-badge{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.2);border-radius:50px;align-items:center;gap:.75rem;margin-bottom:2rem;padding:.625rem 1.5rem;display:inline-flex}.badge-dot{background:#10b981;border-radius:50%;width:8px;height:8px;animation:2s infinite pulse}@keyframes pulse{0%,to{opacity:1}50%{opacity:.5}}.badge-text{color:#fff;letter-spacing:.5px;font-size:.875rem;font-weight:600}.hero-title{color:#fff;margin-bottom:1.5rem;font-size:max(2rem,min(6vw,3.5rem));font-weight:900;line-height:1.1}.hero-gradient-text{-webkit-text-fill-color:transparent;background:linear-gradient(135deg,#60a5fa 0%,#a78bfa 100%);-webkit-background-clip:text;background-clip:text}.hero-description{color:#cbd5e1;max-width:600px;margin-bottom:3rem;font-size:1.1rem;line-height:1.7}.hero-buttons{flex-wrap:wrap;gap:1.25rem;margin-bottom:0;display:flex}.hero-stats{-webkit-backdrop-filter:blur(20px);backdrop-filter:blur(20px);background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.15);border-radius:30px;grid-template-columns:repeat(2,1fr);gap:2.5rem;padding:3rem;display:grid;box-shadow:0 25px 50px rgba(0,0,0,.2)}.stat-card{text-align:center;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:1.5rem;transition:all .3s}.stat-card:hover{background:rgba(255,255,255,.1);transform:translateY(-5px)}.stat-value{color:#fff;font-variant-numeric:tabular-nums;text-shadow:0 2px 10px rgba(0,0,0,.3);margin-bottom:.75rem;font-size:3.5rem;font-weight:900}.stat-label{color:#cbd5e1;text-transform:uppercase;letter-spacing:1px;margin-bottom:.75rem;font-size:1rem;font-weight:600}.stat-trend{color:#10b981;background:rgba(16,185,129,.15);border:1px solid rgba(16,185,129,.3);border-radius:25px;padding:.5rem 1.25rem;font-size:.875rem;font-weight:700;display:inline-block}.clients-section{background:#f8fafc;padding:8rem 0}.clients-carousel{margin-top:4rem;position:relative;overflow:hidden}.clients-track{align-items:center;gap:4rem;animation:30s linear infinite scroll;display:flex}@keyframes scroll{0%{transform:translate(0)}to{transform:translate(-50%)}}.client-logo{background:#fff;border-radius:15px;flex-shrink:0;justify-content:center;align-items:center;width:220px;height:120px;padding:1.5rem;transition:all .3s;display:flex;position:relative;box-shadow:0 8px 30px rgba(0,0,0,.08)}.client-logo:hover{transform:scale(1.1);box-shadow:0 15px 40px rgba(0,0,0,.15)}.client-logo img{object-fit:contain;max-width:100%;max-height:100%}.section{padding:6rem 0;position:relative}.section-alt{background:#f8fafc}.section-header{text-align:center;margin-bottom:4rem}.section-badge{color:#3b82f6;letter-spacing:.5px;text-transform:uppercase;background:linear-gradient(135deg,#eff6ff 0%,#f0f9ff 100%);border-radius:50px;margin-bottom:1rem;padding:.5rem 1.25rem;font-size:.875rem;font-weight:600;display:inline-block}.section-title{color:#0f172a;margin-bottom:1.5rem;font-size:max(2rem,min(5vw,3.5rem));font-weight:900;line-height:1.2}.section-subtitle{color:#64748b;max-width:800px;margin:0 auto;font-size:1.25rem;line-height:1.8}.services-grid{grid-template-columns:repeat(auto-fit,minmax(350px,1fr));gap:2rem;margin-top:4rem;display:grid}.service-card{background:#fff;border-radius:20px;transition:all .4s cubic-bezier(.4,0,.2,1);position:relative;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,.05)}.service-card:hover{transform:translateY(-8px);box-shadow:0 20px 60px rgba(0,0,0,.1)}.service-image{width:100%;height:200px;position:relative;overflow:hidden}.service-image:after{content:"";background:linear-gradient(transparent 0%,rgba(0,0,0,.5) 100%);position:absolute;top:0;bottom:0;left:0;right:0}.service-content{padding:2rem}.service-title{color:#0f172a;margin-bottom:.5rem;font-size:1.5rem;font-weight:800}.service-subtitle{color:#64748b;text-transform:uppercase;letter-spacing:.5px;margin-bottom:1.5rem;font-size:.875rem;font-weight:600}.service-description{color:#475569;margin-bottom:2rem;line-height:1.8}.service-features{list-style:none}.service-feature{align-items:flex-start;gap:.75rem;margin-bottom:1rem;display:flex}.feature-icon{background:linear-gradient(135deg,#10b981,#059669);border-radius:50%;flex-shrink:0;justify-content:center;align-items:center;width:20px;height:20px;margin-top:2px;display:flex}.feature-icon svg{stroke:#fff;stroke-width:3px;width:12px;height:12px}.process-timeline{margin-top:4rem;position:relative}.process-line{opacity:.2;background:linear-gradient(90deg,#3b82f6,#a78bfa);height:2px;position:absolute;top:100px;left:0;right:0}.process-steps{grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:2rem;display:grid;position:relative}.process-step{text-align:center;position:relative}.process-image{border:4px solid #e2e8f0;border-radius:50%;width:150px;height:150px;margin:0 auto 1.5rem;position:relative;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,.1)}.step-number{color:#fff;z-index:1;background:linear-gradient(135deg,#3b82f6,#1d4ed8);border-radius:50%;justify-content:center;align-items:center;width:40px;height:40px;font-size:1rem;font-weight:900;display:flex;position:absolute;top:-10px;right:-10px;box-shadow:0 4px 15px rgba(59,130,246,.4)}.step-title{color:#0f172a;margin-bottom:.75rem;font-size:1.25rem;font-weight:700}.step-description{color:#64748b;margin-bottom:.75rem;line-height:1.6}.step-duration{color:#3b82f6;background:#f0f9ff;border-radius:20px;padding:.25rem .75rem;font-size:.75rem;font-weight:600;display:inline-block}.achievements-grid{grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:3rem;margin-top:4rem;display:grid}.achievement-card{border-radius:20px;transition:transform .3s;position:relative;overflow:hidden;box-shadow:0 15px 40px rgba(0,0,0,.1)}.achievement-card:hover{transform:translateY(-10px)}.achievement-image{width:100%;height:250px;position:relative}.achievement-overlay{background:linear-gradient(transparent 0%,rgba(0,0,0,.8) 100%);padding:2rem;position:absolute;bottom:0;left:0;right:0}.achievement-title{color:#fff;margin-bottom:.5rem;font-size:1.5rem;font-weight:700}.achievement-description{color:rgba(255,255,255,.9);line-height:1.6}.about-section{background:linear-gradient(135deg,#f8fafc 0%,#e0f2fe 100%);padding:6rem 0}.about-grid{grid-template-columns:1fr 1fr;align-items:center;gap:4rem;margin-top:4rem;display:grid}@media (max-width:1024px){.about-grid{grid-template-columns:1fr}}.about-content{padding:2rem}.about-image{border-radius:20px;height:500px;position:relative;overflow:hidden;box-shadow:0 30px 60px rgba(0,0,0,.1)}.about-features{grid-template-columns:1fr 1fr;gap:2rem;margin-top:2rem;display:grid}.about-feature{align-items:start;gap:1rem;display:flex}.about-icon{background:linear-gradient(135deg,#3b82f6,#1d4ed8);border-radius:12px;flex-shrink:0;justify-content:center;align-items:center;width:50px;height:50px;display:flex}.about-feature-text h4{color:#0f172a;margin-bottom:.25rem;font-weight:700}.about-feature-text p{color:#64748b;font-size:.875rem}.cta-section{background:linear-gradient(135deg,#1e40af 0%,#7c3aed 100%);padding:6rem 0;position:relative;overflow:hidden}.cta-pattern{background-image:radial-gradient(circle at 1px 1px,rgba(255,255,255,.1) 1px,transparent 1px);background-size:40px 40px;position:absolute;top:0;bottom:0;left:0;right:0}.cta-wrapper{z-index:1;grid-template-columns:1fr 1fr;align-items:center;gap:4rem;display:grid;position:relative}@media (max-width:1024px){.cta-wrapper{text-align:center;grid-template-columns:1fr}}.cta-content{color:#fff}.cta-title{margin-bottom:1.5rem;font-size:max(2rem,min(5vw,3.5rem));font-weight:900}.cta-description{color:rgba(255,255,255,.9);margin-bottom:3rem;font-size:1.25rem;line-height:1.8}.cta-buttons{flex-wrap:wrap;gap:1.25rem;display:flex}.cta-image{border-radius:20px;height:400px;position:relative;overflow:hidden;box-shadow:0 40px 80px rgba(0,0,0,.3)}.btn-white{color:#1e40af;background:#fff;box-shadow:0 10px 40px rgba(0,0,0,.2)}.btn-white:hover{transform:translateY(-2px);box-shadow:0 15px 50px rgba(0,0,0,.3)}.btn-outline-white{color:#fff;border:2px solid #fff}.btn-outline-white:hover{color:#1e40af;background:#fff}.footer{color:#0f172a;background:#fff;border-top:1px solid #e2e8f0;padding:4rem 0 2rem}.footer-grid{grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:3rem;margin-bottom:3rem;display:grid}.footer-brand{max-width:350px}.footer-logo{align-items:center;margin-bottom:1.5rem;display:flex}.footer-logo-image{width:auto;height:80px}.footer-description{color:#64748b;margin-bottom:1.5rem;line-height:1.8}.footer-social{gap:1rem;display:flex}.social-link{color:#64748b;background:#f1f5f9;border-radius:50%;justify-content:center;align-items:center;width:40px;height:40px;transition:all .3s;display:flex}.social-link:hover{color:#fff;background:#3b82f6;transform:translateY(-2px)}.footer-column h4{color:#0f172a;margin-bottom:1.5rem;font-weight:700}.footer-links{list-style:none}.footer-link{color:#64748b;padding:.5rem 0;text-decoration:none;transition:color .3s;display:block}.footer-link:hover{color:#0f172a}.footer-bottom{border-top:1px solid #e2e8f0;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:1rem;padding-top:2rem;display:flex}.footer-copyright{color:#64748b}.footer-legal{gap:2rem;display:flex}[data-animate]{opacity:0;transform:translateY(30px)}.section-visible{animation:.8s forwards fadeInUp}@keyframes fadeInUp{to{opacity:1;transform:translateY(0)}}@media (max-width:768px){.section{padding:4rem 0}.services-grid{grid-template-columns:1fr;gap:1.5rem}.process-steps{grid-template-columns:1fr}.hero-stats{grid-template-columns:1fr;gap:2rem;padding:2rem}.stat-value{font-size:2.5rem}.footer-grid,.achievements-grid{grid-template-columns:1fr}.clients-track{gap:2rem}.client-logo{width:180px;height:100px}.clients-section{padding:6rem 0}}'
            }, void 0, false, void 0, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-55dca5f051986228" + " " + "loader ".concat(!isLoading ? 'hidden' : ''),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                className: "jsx-55dca5f051986228" + " " + "nav-header ".concat(isScrolled ? 'scrolled' : ''),
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "jsx-55dca5f051986228" + " " + "mobile-menu-btn ".concat(mobileMenuOpen ? 'active' : ''),
                                    children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-55dca5f051986228" + " " + "mobile-menu ".concat(mobileMenuOpen ? 'active' : ''),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Muchas empresas líderes confían en Humanis para construir equipos ejecutivos de alto rendimiento y transformar sus organizaciones con talento excepcional."
                                }, void 0, false, {
                                    fileName: "[project]/app/page.js",
                                    lineNumber: 1420,
                                    columnNumber: 13
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "jsx-55dca5f051986228" + " " + "section-subtitle",
                                    children: "Metodología propietaria respaldada por tecnología de vanguardia y una red exclusiva de más de 1,000 ejecutivos verificados en toda la República Mexicana."
                                }, void 0, false, {
                                    fileName: "[project]/app/page.js",
                                    lineNumber: 1449,
                                    columnNumber: 13
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "jsx-55dca5f051986228",
                                                                    children: "+1,000 ejecutivos verificados"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/page.js",
                                                                    lineNumber: 1562,
                                                                    columnNumber: 21
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "jsx-55dca5f051986228",
                                                                    children: "60 días de reemplazo sin costo"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/page.js",
                                                                    lineNumber: 1575,
                                                                    columnNumber: 21
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "jsx-55dca5f051986228",
                                                                    children: "9 días promedio de colocación"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/page.js",
                                                                    lineNumber: 1588,
                                                                    columnNumber: 21
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "jsx-55dca5f051986228",
                                                                    children: "3  meses de acompañamiento"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/page.js",
                                                                    lineNumber: 1603,
                                                                    columnNumber: 21
...
_s(HomePage, "EXdqZ67AakiqR+UVFniEuyY4E/E=");
_c = HomePage;
var _c;
