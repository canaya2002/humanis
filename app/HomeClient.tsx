...
// --- INTERFAZ PARA PROPS (Recibimos los datos, no los definimos aquí) ---
...
const ModernButton = ({ children, onClick, secondary = false }: { children: React.ReactNode; onClick?: () => void; secondary?: boolean; }) => (
...
// --- SERVICIOS ---
const ServicesScrollSection = ({ data }: { data: SolutionItem[] }) => {
...
// NOTA IMPORTANTE: Recibimos solutionsData como prop para mantener el Schema en el servidor (page.tsx)
export default function HomeClient({ solutionsData }: HomeClientProps) {
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-cyan-100 selection:text-cyan-900 overflow-x-hidden">
        ...
        <main className="pt-0">
            ...
            <ServicesScrollSection data={solutionsData} />
